...
router.post('/', (req, res) => {
    try {
        ...
        const query = `INSERT INTO users(name, username, email, password, role, profile_image, external_account, valid)
                       VALUES ($1, $2, $3, $4, 'USER', $5, $6, $7)
                       RETURNING *;`;
        const validationQuery = `INSERT INTO validation_tokens(token, username, password, expiration_date)
                                 VALUES ($1, $2, $3, $4);`;
        let user = null;
